...
let coursesArray = [
    ...
    },
    {
        ...
        monthDuration: 5,
        hourDuration: 909,
        modules: ['', 'css', 'js', 'mysql', 'mongodb', 'react', 'angular', 'aws', 'docker', 'git', 'node.js']
    },
    {
        title: 'Mysql Complex',
        monthDuration: 5,
    ...
    {
        title: 'Node.js Complex',
        monthDuration: 5,
        hourDuration: 909,
        modules: ['', 'css', 'js', 'mysql', 'mongodb', 'react', 'angular', 'aws', 'docker', 'git', 'node.js']
    },
    {
        title: 'Core java Complex',
        monthDuration: 6,
        hourDuration: 909,
        modules: ['html',
            'css',
...
// // // @@@@@@@ New @@@@@@@
// відсортувати його по алфавіту

let sortCoursesArrayABC = coursesArray.sort((a,b)=>{
    if (a.title<b.title){
        return -1
...
console.log(sortCoursesArrayABC);
